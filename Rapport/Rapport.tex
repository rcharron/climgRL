...
%=> il faut le modèle avec un traitement anti bruit
	...
	\paragraph{Résistance aux occlusions}
	  ...
	  De par sa nature, l'estimateur résiste très très mal aux occlusion qui vont faire diminuer drastiquement la solidité. Dem même que pour l'élongation, aucune solution n'a été réellement recherchée pour résoudre ce problème.
    ...
    \subsection{Pistes non explorées}
        \subsubsection{Transformée de Fourier}  %A mettre ? RAphaël
