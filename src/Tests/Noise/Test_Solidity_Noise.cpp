...
void Test_Solidity_Noise (){
  ...
  cout << "Chopper 4 (noise 0) : " << Solidity(test) << "\n";
  test.iterRemoveNoise();
  cout << "Chopper 4 (noise 0, debruite) : " << Solidity(test) << "\n";
  
  test = MetaImage("../src/Tests/Noise/chopper-4.3.pgm");
  cout << "Chopper 4 (noise 0.3) : " << Solidity(test) << "\n";
  test.iterRemoveNoise();
  cout << "Chopper 4 (noise 0.3, debruite) : " << Solidity(test) << "\n";
  
  test = MetaImage("../src/Tests/Noise/chopper-4.5.pgm");
  cout << "Chopper 4 (noise 0.5) : " << Solidity(test) << "\n";
  test.iterRemoveNoise();
  cout << "Chopper 4 (noise 0.5, debruite) : " << Solidity(test) << "\n";
  
  test = MetaImage("../src/Tests/Noise/chopper-4.8.pgm");
  cout << "Chopper 4 (noise 0.8) : " << Solidity(test) << "\n";
  test.iterRemoveNoise();
  cout << "Chopper 4 (noise 0.8, debruite) : " << Solidity(test) << "\n";
  
  cout <<"\n DEVICE0 7 :\n";
  
  test = MetaImage("../src/Tests/Noise/device0-7.pgm");
  cout << "Device0 7 (noise 0) : " << Solidity(test) << "\n";
  test.iterRemoveNoise();
  cout << "Device0 7 (noise 0, debruite) : " << Solidity(test) << "\n";
  
  test = MetaImage("../src/Tests/Noise/device0-7.3.pgm");
  cout << "Device0 7 (noise 0.3) : " << Solidity(test) << "\n";
  test.iterRemoveNoise();
  cout << "Device0 7 (noise 0.3, debruite) : " << Solidity(test) << "\n";
  
  test = MetaImage("../src/Tests/Noise/device0-7.5.pgm");
  cout << "Device0 7 (noise 0.5) : " << Solidity(test) << "\n";
  test.iterRemoveNoise();
  cout << "Device0 7 (noise 0.5, debruite) : " << Solidity(test) << "\n";
  
  test = MetaImage("../src/Tests/Noise/device0-7.8.pgm");
  cout << "Device0 7 (noise 0.8) : " << Solidity(test) << "\n";
  test.iterRemoveNoise();
  cout << "Device0 7 (noise 0.8, debruite) : " << Solidity(test) << "\n";
